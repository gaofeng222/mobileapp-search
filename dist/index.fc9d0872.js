...
})({"04liS":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "23357339fc9d0872";
"use strict";
...
},{}],"2TVAZ":[function(require,module,exports) {
var _utils = require("./utils");
window.onload = function() {
    let wrap = (0, _utils.getId)("wrap");
    let list = (0, _utils.getId)("list");
    ...
    (0, _utils.cssTransform)(list, "translateX", 0);
    console.log(lis.length, "lis.length");
    wrap.addEventListener("touchstart", (e)=>{
        e.preventDefault();
        list.style.transition = ".5s";
        let now = Math.round(-(0, _utils.cssTransform)(list, "translateX") / wrap.offsetWidth);
        if (now == 0) now = navs.length;
        if (now == lis.length - 1) now = navs.length - 1;
        console.log(now, "now");
        (0, _utils.cssTransform)(list, "translateX", -now * wrap.offsetWidth);
        startPoint = e.changedTouches[0].pageX;
        startX = (0, _utils.cssTransform)(list, "translateX");
    });
    wrap.addEventListener("touchmove", (e)=>{
        ...
        (0, _utils.cssTransform)(list, "translateX", startX + dis);
        list.style.WebkitTransform = list.style.transform = `translateX(${(0, _utils.cssTransform)(list, "translateX")}px)`;
    });
    wrap.addEventListener("touchend", (e)=>{
        let now = Math.round(-(0, _utils.cssTransform)(list, "translateX") / wrap.offsetWidth);
        list.style.transition = ".5s";
        (0, _utils.cssTransform)(list, "translateX", -now * wrap.offsetWidth);
        for(let i = 0; i < navs.length; i++)navs[i].className = "";
...
function cssTransform(el, attr, val) {
    ...
    if (arguments.length > 2) {
        ...
        let sValue = "";
        for(let key in el.transform)switch(key){
            case "rotate":
            case "skewX":
            case "skewY":
...
},{}]},["04liS","2TVAZ"], "2TVAZ", "parcelRequire00df")

//# sourceMappingURL=index.fc9d0872.js.map
